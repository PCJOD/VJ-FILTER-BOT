...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/pcott')
...
URL = "shrill-sophi-ufkkkk-e394168a.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "shrill-sophi-ufkkkk-e394168a.koyeb.app".format(FQDN, PORT)
